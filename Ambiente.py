...
class Ambiente(Env):
    ...
    def _render_gui(self, mode):
        ...
        if self.start_img is None:
            file_name = path.join(path.dirname(__file__), "img/tent.png")
        ...
        if self.presente_img is None:
            file_name = path.join(path.dirname(__file__), "img/diamond.png")
        ...
        if self.elf_images is None:
            player = [
                path.join(path.dirname(__file__), "img/playerLeft.png"),
                path.join(path.dirname(__file__), "img/playerDown.png"),
                path.join(path.dirname(__file__), "img/playerRight.png"),
                path.join(path.dirname(__file__), "img/playerUp.png"),
            ]
            self.elf_images = [
                pygame.transform.scale(pygame.image.load(f_name), self.cell_size)
                for f_name in player
            ]
